...
def _web_fetch(arguments: dict[str, Any], context: ToolExecutionContext) -> str:
    """通过 HTTP/HTTPS 获取远程文本资源并返回截断后的内容。"""
